...
/>
      ...
      <SplitText
  text="SEKMED"
  className="absolute md:ml-36 ml-6 drop-shadow-md sm:text-9xl md:text-[350px] md:mt-10 text-7xl mb-16 font-cool text-white font-extrabold mt-10  text-center z-[60] "
  delay={150}
...
{isInstallable && (
  <button
    ...
    className="fixed top-5 right-5 z-[60] bg-White drop-shadow-md rounded-full md:text-2xl text-lg text-Black px-4 py-2 font-cool shadow-lg hover:bg-white hover:ring-0 bg-white hover:drop-shadow-xl hover:ring-black hover:text-black"
  >
    Install App
  </button>
)}
  ...
  {/* Clickable Link */}
 <Link to="/home">
        <button className="font-cool z-[100] drop-shadow-md  md:mt-[550px] md:text-4xl bg-white   rounded-full  hover:drop-shadow-2xl hover:ring-0 hover:bg-white hover:text-black animate-pulse   text-2xl mb-44 px-4 py-2 mt-72 ">
          Get Started
        </button>
      </Link>
    </div>
