...
<img 
  src={sekmed_logo} 
  alt="Sekmed Logo" 
  className="absolute rotate-45 top-5 left-5 w-16 sm:w-20 md:w-24 lg:w-28 xl:w-32 "
/>
      ...
      {/* Clickable Link */}
      <Link to="/home">
        <button className="font-cool z-[70] md:mt-[500px] md:text-4xl bg-black text-white rounded-full hover:ring-2 hover:ring-black hover:bg-white hover:text-black animate-pulse  translate-y-28 text-2xl mb-44 px-4 py-2 mt-96 cursor-pointer">
          Get Started
        </button>
      </Link>
...
{isInstallable && (
  <button
    ...
    className="fixed top-5 right-5 z-[60] bg-black rounded-full text-2xl text-white px-4 py-2 font-cool shadow-lg hover:bg-white hover:ring-2 hover:ring-black hover:text-black"
  >
    Install App
  </button>
)}
