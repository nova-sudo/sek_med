...
/>
      ...
      <SplitText
  text="SEKMED"
  className="absolute opacity-90 md:ml-36 ml-6   sm:text-9xl md:text-[350px] md:mt-10 text-7xl mb-16 font-cool text-zinc-800 drop-shadow-lg font-extrabold mt-10  text-center z-[60] "
  delay={150}
...
{isInstallable && (
  ...
  >
    Install App
      ...
      <Spline
        ...
        scene="https://prod.spline.design/RmfgTzu1RVdX8tgn/scene.splinecode"
        width="100%"
        height="100%"
      /> 
  ...
  {/* Clickable Link */}
 <Link to="/home">
        <button className="font-cool z-[100] drop-shadow-md sm:mt-[350px] md:mt-[550px] md:text-4xl bg-zinc-800   text-white rounded-full  hover:drop-shadow-2xl hover:ring-0 hover:bg-white hover:text-zinc-800 animate-pulse   text-2xl mb-44 px-4 py-2 mt-72 ">
          Get Started
        </button>
      </Link>
    </div>
